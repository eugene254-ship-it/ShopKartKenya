...
<head>
  ...
  <title>Qwetu Business Hub </title>
  <!-- plugins:css -->
        ...
        <div class="mx-0 row w-100">
          <div class="mx-auto col-lg-4">
            <div class="px-4 py-5 text-left auth-form-light px-sm-5">
              ...
              <h4>Qwetu Business Hub</h4>
              <h6 class="font-weight-light">Enter Your Details Manually</h6>
              ...
              <form class="pt-3" action="{{ url('admin/login') }}" method="post">@csrf
                <div class="form-group">
                  <input type="text" name="email" id="email" class="form-control form-control-lg" id="exampleInputEmail1" placeholder="Email" required="" >
                </div>
                <div class="form-group">
                ...
                <div class="mb-2">
                  <button type="button" class="btn btn-block btn-facebook auth-form-btn">
                    <i class=""></i>Login using Your Qwetu ID
                  </button>
                </div>
